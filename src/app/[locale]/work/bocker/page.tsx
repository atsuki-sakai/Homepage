            ...
            <div className="rounded-3xl border border-neutral-200 p-6">
              ...
              <ul className="mt-6 space-y-2">
                {feature.details.map((detail: string) => (
                  <li key={detail} className="flex items-center text-sm text-neutral-700">
    ...
    <>
      <div className='grid grid-cols-2 max-w-7xl mx-auto'>
        ...
        >
            ...
            <Button href="https://bocker.jp/ja" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mx-auto max-w-5xl">
              <dl className="-mx-6 grid grid-cols-1 text-sm text-neutral-950 sm:mx-0 sm:grid-cols-3">
                <div className="border-t border-neutral-200 px-6 py-4 first:border-t-0 sm:border-t-0 sm:border-l">
                  <dt className="font-semibold">{t('projectInfo.industry.title')}</dt>
                ...
                <div className="border-t border-neutral-200 px-6 py-4 first:border-t-0 sm:border-t-0 sm:border-l">
                  <dt className="font-semibold">{t('projectInfo.features.title')}</dt>
                ...
                <div className="border-t border-neutral-200 px-6 py-4 first:border-t-0 sm:border-t-0 sm:border-l">
                  <dt className="font-semibold">{t('projectInfo.development.title')}</dt>
